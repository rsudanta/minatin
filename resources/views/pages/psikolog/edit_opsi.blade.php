    ...
    <div class="main">
        ...
        <div class="content-home">
            ...
            <div class="container-input-hasil">
                ...
                <form action=" {{ route('psikolog.psikotest.opsi.update', $items->id) }}" method="post">
                    @csrf
                    <input type="text" name="opsi" placeholder="Opsi.." class="form-control question_list"
                        value="{{ $items->opsi }}" required />
                    <div class="pt-2">
