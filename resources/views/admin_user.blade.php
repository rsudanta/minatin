...
<body>
    ...
    <div class="sidenav">
        ...
        <a href="#contact" class="active"><i class="fas fa-user-alt"></i>User</a>
        <a href="#services"><i class="fas fa-shopping-cart"></i>Order</a>
                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary" type="button" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-edit"></i></button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
